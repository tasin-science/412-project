...
export function validateLg() {
    ...
    document.body.innerHTML = `
      ...
      <nav class="navbar_regerr">
        <ul class="navlist_regerr">
            ...
            <li><a class="active_list" href="login.html">Login</a></li>
      ...
      <main class="inputation_system">
        <div class="regerr_page" id="regPage">
          <h2 class="regerr_h2">Login your account</h2>
          ...
          <button id="loginBtn" class="regerr_btn">Login</button>
        </div>
      </main>
    `;
  ...
  if (newBtn) {
    newBtn.addEventListener('click', validateLg);
  }
